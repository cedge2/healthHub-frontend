...
function Doctors() {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        const response = await axios.get("http://localhost:3001/doctors"); // Replace with your actual API URL
        setDoctors(response.data.doctors); // Make sure to adjust according to your actual API response structure
      } catch (error) {
